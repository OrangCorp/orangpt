...
class TextClassifier:
    ...
    def create_classifier(self,selected_language, selected_model, save_model=False):
    ...
    def load_model(self,selected_language, selected_model):
    ...
    def classify_tone(self,text: str, selected_language: str, selected_model: str):
        ...
        if(selected_model=="Small Language Model (SLM)"):
            if(selected_language=="Polish"):
                 clf=self.slm_model_polish

            else:
                if(selected_language=="English"):
                    clf=self.slm_model_english
            ...
            clf = self.load_model(selected_language, selected_model)
    ...
    def get_highlighted_words(self, text, selected_language, selected_model, fraction_of_words=0.33, min_number_of_words=1, max_number_of_words=10):
        if(selected_model=="Small Language Model (SLM)"):
            ...
            if(selected_language=="Polish"):
                ...
                if(selected_language=="English"):
                    ...
                    raise NotImplementedError 
            return clf.loaded_data['important_words']
        else: 
            clf = self.load_model(selected_language, selected_model)
